    ...
    value: function getConversations(messages) {
      ...
      var listItems = messages.map(function (message, index) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement('img', { className: 'img-circle'+bubbleClass, src: message.image }),
          _react2.default.createElement(
            'div',{className: 'bubble ' + bubbleClass},
            _react2.default.createElement( 'span',{ dangerouslySetInnerHTML: { __html: message.text } } ),
            _react2.default.createElement('div', { className: 'text'+bubbleClass},_react2.default.createElement('small',{ dangerouslySetInnerHTML: { __html: message.when + (bubbleClass=='you' ? message.is_read == 1 ? ' <i class="fal fa-check-double blue"></i>' : ' <i class="fal fa-check"></i>' : '')} }))
          )
        );
      });
      return listItems;
